                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                                    ...
                                                    <tr>
                                                        <td style="line-height:0;">
                                                            <a target="_blank" style="text-decoration:none;"
                                                               href="https://geekytheory.com"><img
                                                                        src="https://geekytheory.com/uploads/2017/05/logo%2032.png"
                                                                        border="0"
                                                                        style="font:bold 12px/12px Arial, Helvetica, sans-serif; color:#606060;"
                                                                        align="left" vspace="0" hspace="0" width="50"
                                                                        height="auto" alt="GEEKYTHEORY.COM"/></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </th>
                                            <th class="flex" align="left" style="padding:0;">
                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td data-color="text" data-size="size navigation" data-min="10"
                                                            data-max="22"
                                                            ...
                                                            <a target="_blank" style="text-decoration:none; color:#888;"
                                                               href="https://geekytheory.com">Inicio</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </th>
                ...
                <tr>
                    <td data-bgcolor="bg-module" bgcolor="#eaeced">
                        <table class="flexible" width="600" align="center" style="margin:0 auto;" cellpadding="0"
                               cellspacing="0">
                            <tr>
                                <td class="img-flex"><img src="https://geekytheory.com/uploads/2017/05/confirm.jpg"
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td data-color="text" data-size="size text" data-min="10" data-max="26"
                                                ...
                                                Necesitamos que confirmes tu dirección de correo electrónico para poder
                                                darte información acerca de las cosas geniales que estamos creando.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding:0 0 20px;">
                                                <table width="134" align="center" style="margin:0 auto;" cellpadding="0"
                                                       cellspacing="0">
                                                    <tr>
                                                        <td data-bgcolor="bg-button" data-size="size button"
                                                            ...
                                                            <a target="_blank"
                                                               ...
                                                               href="{{ $confirmationUrl }}">Confirmar</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                ...
                                                <table class="center" align="right" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td class="btn" valign="top"
                                                            ...
                                                            <a target="_blank" style="text-decoration:none;"
                                                               href="http://facebook.com/geekytheory"><img
                                                                        src="https://geekytheory.com/uploads/2017/05/ico-facebook.png"
                                                                        border="0"
                                                        ...
                                                        <td class="btn" valign="top"
                                                            style="line-height:0; padding:3px 0 0;">
                                                            <a target="_blank" style="text-decoration:none;"
                                                               href="http://twitter.com/geekytheory"><img
                                                                        src="https://geekytheory.com/uploads/2017/05/ico-twitter.png"
                                                                        border="0"
                                                                        style="font:12px/15px Arial, Helvetica, sans-serif; color:#797c82;"
                                                        ...
                                                        <td class="btn" valign="top"
                                                            style="line-height:0; padding:3px 0 0;">
                                                            <a target="_blank" style="text-decoration:none;"
                                                               href="http://plus.google.com/+geekytheory"><img
                                                                        src="https://geekytheory.com/uploads/2017/05/ico-google-plus.png"
                                                                        border="0"
                                                                        style="font:12px/15px Arial, Helvetica, sans-serif; color:#797c82;"
                                                        ...
                                                        <td class="btn" valign="top"
                                                            style="line-height:0; padding:3px 0 0;">
                                                            <a target="_blank" style="text-decoration:none;"
                                                               href="http://instagram.com/geekytheory"><img
                                                                        src="https://geekytheory.com/uploads/2017/05/ico-instagram-min.png"
                                                                        border="0"
                                                                        style="font:12px/15px Arial, Helvetica, sans-serif; color:#797c82;"
                                                                        align="left" vspace="0" hspace="0" width="14"
                                                                        height="14" alt="in"/></a>
                                                        </td>
                                                    </tr>
                                                </table>
